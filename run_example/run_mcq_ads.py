...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="mcqData-up-test")#mcqData-f5-r0.8-a-6-up7
    parser.add_argument("--task", type=str, default="antmaze-large-diverse-v2")
    ...
    parser.add_argument("--lmbda", type=float, default=0.7)
...
def train(args=get_args()):
    ...
    # ss = []
    # with open("/home/uas/yqx/off-kit/hopper-medium-v2-5.pkl", "rb") as f:
    #     ls = pickle.load(f)
    #     for i in ls:
    #         ss.append(len(i))
    # sums = sum(ss)
